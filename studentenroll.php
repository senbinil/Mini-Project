...
<div class="container">
    <form action="enrollsub.php"  method="POST" class=""> 
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" name="blood" class="form-control" required maxlength="3" minlength="1" autocomplete="off">
            </div>
        </div>
        <div class=" row form-group">
            <label for="" class="col-form-label col-sm-3">Address</label>
            <div class="col-sm-4">
                <input type="text" name="address" class="form-control" required minlength="10" autocomplete="off">
            </div>
        ...
        <div class=" row form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="zipcode" class="form-control" required minlength="6" maxlength="6" autocomplete="off">
            </div>
        </div>
        <div class="row form-group">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" name="phone" maxlength="10" class="form-control" onkeypress="return onlyNumberKey(event)" required maxlength="10" minlength="10" autocomplete="off">
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3 " >
                <input type="text" name="roll_no" class="form-control" onkeypress="return onlyNumberKey(event)" required minlength="4" autocomplete="off">
            </div>
       ...
       <div class=" bg-info py-2 pl-2 my-2  text-white instit">
            ...
            <div class="col-sm-3 ">
                <input type="email" name="email_id" class="form-control" required autocomplete="off">
            </div>
